...
const miniPlayer = () => {
  document.querySelector(".music_player").classList.add("miniplayer");
};

const fullPlayer = () => {
  document.querySelector(".music_player").classList.remove("miniplayer");
};
...
var styles = {
  title_time_wrapper: "_wKo5X",
  buttons_volume_wrapper: "_2_1sf",
  sec_wrapper: "testsa",
};

var styles$1 = { wrapper: "music_player miniplayer" };
...
var styles$2 = { wrapper: "music_player_wrapper" };
...
var styles$imgcover = { coverimg: "coverimage" };
var CoverImg = function CoverImg(props) {
  return /*#__PURE__*/ React__default.createElement(
    "img",
    {
      className: styles$imgcover.img,
      src: props.coverimg,
    },
    props.coverimg
  );
...
var styles$3 = { title: "h1_music_title" };
...
var styles$5 = { container: "musicslider_container", slider: "musicslider" };
...
var Progress = function Progress(props) {
  return /*#__PURE__*/ React__default.createElement(
    ...
    /*#__PURE__*/ React__default.createElement("input", {
      ...
      style: {
        background:
          "linear-gradient(90deg, var(--progressUsed) " +
...
var styles$6 = { wrapper: "music_fuction_btn" };
...
var styles$d = { wrapper: "vol_wrapper", slider: "vol_slider" };
...
var Volume = function Volume(props) {
  return /*#__PURE__*/ React__default.createElement(
    ...
    /*#__PURE__*/ React__default.createElement("input", {
      ...
      style: {
        background:
          "linear-gradient(90deg, var(--volumeUsed) " +
          props.value * 100 +
          "%, var(--volumeLeft) " +
          props.value * 100 +
          "%)",
...
var styles$e = { wrapper: "music_playlist" };
...
var Player = function Player(_ref) {
  var trackList = _ref.trackList,
    ...
    autoPlayNextTrack =
      _ref$autoPlayNextTrac === void 0 ? true : _ref$autoPlayNextTrac,
    _ref$customColorSchem = _ref.customColorScheme,
    customColorScheme =
      _ref$customColorSchem === void 0 ? colors : _ref$customColorSchem;
  ...
  var GlobalStyles = styledComponents.createGlobalStyle(
    _templateObject ||
  ...
  return /*#__PURE__*/ React__default.createElement(
    PageTemplate,
    null,
    /*#__PURE__*/ React__default.createElement(GlobalStyles, null),
    includeTags &&
    ...
    React__default.createElement(
      ...
      React__default.createElement("div", {
        className: "minimal_btn",
        onClick: miniPlayer,
      
      }),
      React__default.createElement("div", {
        className: "fullplayer_btn",
        onClick: fullPlayer,
      },
      ...
      /*#__PURE__*/ React__default.createElement("div", {
        ...
        React__default.createElement(CoverImg, {
          src: "img",
        })
      ) /*#__PURE__*/,

      React__default.createElement("div", {
        className: "music_desc-wrapper",
        id: "egion-BG",
        },

        React__default.createElement("div", {
          className: "music_title",
        },
      ...
      React__default.createElement("div", {
        className: "music_fuction",
        },
        /*#__PURE__*/ React__default.createElement(
          ButtonsBox,
          null,
          /*#__PURE__*/ React__default.createElement(LoopCurrent, {
