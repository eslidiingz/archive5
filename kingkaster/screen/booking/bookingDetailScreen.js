...
const bookingDetailScreen = ({ route, navigation }) => {
    ...
    const checkCode = async () => {
        navigation.navigate('CouponScreen', { title: title, colorHeader: colorHeader, type: 'booking' })
            ...
            <SafeAreaView style={[styles.screen]}>
                ...
                <View style={stylesPage.subHeader}>
                    <Text style={[stylesPage.inSubHeader, fontStyles.Medium18]}>
                        ทั้งหมด : <Text style={{ color: colors.success }}> {time.length} ชั่วโมง</Text>
                    </Text>
                </View>
                <View style={[{ backgroundColor: colors.darkGreyBlue1, marginTop: hp(10) }]}>
                    <View style={[styles.container, stylesPage.containerBox]}>
                        ...
                        <Input
                            ...
                            // errorMessage={
                            //     checkcode !== null ?
                            //         checkcode[0].status.code === 0 ?
                            //             checkcode[0].status.string
                            //             :
                            //             null ||
                            //                 checkcode[0].status.code === 1 && codeMore === false ?
                            //                 `คุณได้รับส่วนลด -${checkcode[0].discount} KK`
                            //                 : 'ไม่สามารถใช้โค้ดส่วนลดเพิ่มได้'
                            //         :
                            //         null
                            // }
                            autoCorrect={false}
                        ...
                        // errorStyle={[fontStyles.Light16, checkcode !== null ? checkcode[0].status.code === 0 ? { color: colors.red } : { color: colors.success } : null]}
                        />
                    </View>
                </View>
                <View style={[{ backgroundColor: colors.darkGreyBlue1, marginTop: hp(10) }]}>
